...
public class TweetServiceImpl implements TweetService {
  ...
  public List<UserResponseDto> getLikes(Long id) {
    ...
    List<User> likes = new ArrayList<>(likesSet);
  ...
  public TweetResponseDto createTweet(TweetRequestDto tweetRequestDto) {
    ...
    if (checkCredentials(userCredentials)) {
      ...
      Tweet tweet = tweetRepository.saveAndFlush(tweetMapper.requestDtoToEntity(tweetRequestDto));
      ...
      author.ifPresent(tweet::setAuthor);
...
//      }
      ...
      parseAndAddHashtags(tweet);
      parseAndAddMentions(tweet);
